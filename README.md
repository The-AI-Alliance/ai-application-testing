...
| :--------------------------- | ---------: | -----: | :---- |
| `gemma4:12b`                 |  12 B | 8.3 GB | **Default model used in the `Makefile`.** Excellent performance, requiring about 8.3 GB, so it provides a good balance between performance and efficiency. The larger `gemma4` models available, `26b` and `31b` work even better, but require much more memory. |
